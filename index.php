...
<body>
    <div class="container-xxl bg-white p-0">
                            ...
                            <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
                                <div class="property-item rounded overflow-hidden">
                                    <div class="position-relative overflow-hidden">
                                        ...
                                        <div class="bg-white rounded-top position-absolute start-0 bottom-0 mx-4 pt-1 px-3" style = "color: #5D59AF;">Appartment</div>
                                    </div>
                                    <div class="p-4 pb-0">
                            ...
                            <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.5s">
                                <div class="property-item rounded overflow-hidden">
                                    <div class="position-relative overflow-hidden">
                                        <a href=""><img class="img-fluid" src="images/sample.jpg" alt=""></a>
                                        <div class="rounded text-white position-absolute start-0 top-0 m-4 py-1 px-3" style = "background: #5D59AF;">For Rent</div>
                                        <div class="bg-white rounded-top position-absolute start-0 bottom-0 mx-4 pt-1 px-3" style = "color: #5D59AF;">Shop</div>
                                    </div>
                                    <div class="p-4 pb-0">
                                        <h5 class="mb-3" style = "color: #5D59AF;">$12,345</h5>
                                        <a class="d-block h5 mb-2" href="">Golden Urban House For Sell</a>
        ...
        <!-- Back to Top -->
        <a href="#" class="btn btn-lg btn-lg-square back-to-top" style = "background: #5D59AF;"><i class="bi bi-arrow-up"></i></a>
    </div>
