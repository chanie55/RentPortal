            ...
            <div id="content">
		        ...
		        <div class="top-navbar">
                    <nav class="navbar navbar-expand-lg">
					    ...
					    <a class="navbar-brand" href="#"> Scheduled Visit </a>
                            ...
                            <div class="table-title">
                                <div class="row">
                                    <div class="col-sm-6 p-0 d-flex justify-content-lg-start justify-content-center">
                                        <h2 class="ml-lg-2">List of User Scheduled Visits</h2>
                                    </div>
                                </div>
                                    ...
                                    <?php
                                        if ($page >= 2) {
                                            echo "<li class = 'page-item'>
                                                <a class = 'page-link' href = 'visitRecord.php?page=".($page-1)."'> 
                                        ...
                                        for ($counter = 1; $counter <= $total_pages; $counter++){
                                            if ($counter == $page) {
                                                ...
                                                <a class = 'page-link' href= 'visitRecord?page="
                                                .$counter."'>".$counter." </a></li>";
                                            } else {
                                                $link .= "<li class = 'page-item'>
                                                <a class = 'page-link' href='visitRecord.php?page=".$counter."'> ".$counter." </a> </li>";
                                            }
                                        };
