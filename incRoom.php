                                    ...
                                    <tr class = "data-row"> 
                                        ...
                                        <td>
                                            <?php
                                               ...
                                               // echo '<p> <a href = "deletetype.php?room_ID='.$row['room_ID'].'"> <i class = "bx bxs-trash-alt"> </i> </a> </p>';
                                            ?>
                                                ...
                                                <div class="modal-dialog" role="document">
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-footer">
                                                            <button type="button" class="btn btn-secondary" data-dismiss="modal">Cancel</button>
                                                            <?php
                                                                echo '<p> <a href = "deletetype.php?room_ID='.$row['room_ID'].'"> <button type="button" class="btn btn-primary" name = "">Confirm</button> </a></p>';
                                                            ?>
                                                        </div>
                                                    </div>
                                                </div>
