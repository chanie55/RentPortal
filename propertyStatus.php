...
<html lang="en">
    <head>
        ...
        <style>
            <?php
                include "css/propertyStatus.css"
            ?>
        </style>
                ...
                <ul class="list-unstyled components">
                    ...
                    <li class="dropdown">
                        ...
                        <ul class="collapse list-unstyled menu" id="pageSubmenu2">
                            ...
                            <li>
                                <a href="propertyStatus.php">Property Status</a>
                            </li>
                            <li>
                    ...
                    <div class="container-xl">
                        ...
                        <div class="row">
                            <div class="col-sm-6 p-0 d-flex justify-content-lg-start justify-content-center">
                                <h2 class="ml-lg-2">Property Status </h2>
                            </div>
                        </div>
                        ...
                        <?php
                            ...
                            while ($row = mysqli_fetch_assoc($result)) {
                                ?>
                                    <tr class = "data-row"> 
                                        <td> <?php echo $row['propertyType_ID'] ?> </td>
                        ...
                        <?php
                            ...
                            $query =  "SELECT COUNT(*) FROM propertytype";
                        ...
                        <?php
                            if ($page >= 2) {
                                ...
                                <a class = 'page-link' href = 'propertyCategory.php?page=".($page-1)."'> 
                            ...
                            for ($counter = 1; $counter <= $total_pages; $counter++){
                                if ($counter == $page) {
                                    ...
                                    <a class = 'page-link' href= 'propertyCategory?page="
                                    .$counter."'>".$counter." </a></li>";
                                } else {
                                    $link .= "<li class = 'page-item'>
                                    <a class = 'page-link' href='propertyCategory.php?page=".$counter."'> ".$counter." </a> </li>";
                                }
                            };
